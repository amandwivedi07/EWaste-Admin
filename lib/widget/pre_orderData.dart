...
class PreOrderData extends StatefulWidget {
  const PreOrderData({Key? key}) : super(key: key);

  @override
  State<PreOrderData> createState() => _PreOrderDataState();
}

class _PreOrderDataState extends State<PreOrderData> {
  @override
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<QuerySnapshot>(
        stream: _services.orders
            .where('orderType', isEqualTo: 'Pre-Order')
